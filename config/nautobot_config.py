...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "rf8j1ib)f780y50evoebz3j8b0%odg&amp;cnk#(izu7%5r*4vo4=a")
...
# # Plugin configuration for all plugins
# PLUGINS_CONFIG = {
#     "nautobot_plugin_nornir": {
...
#     },
#     "nautobot_chatops": {
#         # ChatOps plugin requires platform-specific configuration
#         # Configure through the UI after enabling
#     },
#     "nautobot_design_builder": {
#         # Design Builder plugin typically doesn't require configuration
#     },
#     "nautobot_secrets_providers": {
#         # Secrets Providers plugin requires provider-specific configuration
#         # Configure through the UI after enabling
#     },
#     "nautobot_ssot": {
